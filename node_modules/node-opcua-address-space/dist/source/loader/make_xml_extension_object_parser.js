...
function _makeTypeReader(dataTypeNodeId, definitionMap, readerMap) {
    ...
    if (dataTypeNodeId.namespace === 0 &&
        ...
        dataTypeNodeId.value < node_opcua_variant_1.DataType.ExtensionObject) {
        const name = node_opcua_variant_1.DataType[dataTypeNodeId.value];
